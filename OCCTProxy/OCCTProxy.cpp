...
public:
	...
	bool InitViewer(System::IntPtr hNativeWindow)
	{
		...
		myView()->SetWindow(pWNTWindow);




		if (!pWNTWindow->IsMapped())
		{
			pWNTWindow->Map();
		}
	...
	bool InitViewer(System::IntPtr hNativeWindow, System::IntPtr glCtx)
	{
		try
		{
			Handle(Aspect_DisplayConnection) aDisplayConnection;
...
public ref class GLFWindowManaged {

private:
	GlfwOcctWindow* Window;
};
// ================================================================
